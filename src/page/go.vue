  ...
  mounted () {
    ...
    mySelf.myDiagram.nodeTemplate =
        MAKE(go.Node,
          ...
          MAKE(go.Shape, 'RoundedRectangle', { fill: '#44CCFF', stroke: 'blue', strokeWidth: 1, angle: 0 }),
          ...
          MAKE(go.Panel, 'Horizontal', { padding: 1 },
            MAKE(go.Panel, 'Vertical',
              MAKE(go.Picture,
                // { margin: 10, width: 50, height: 50, background: "blue" }, //子节点的前方背景图区域
                { width: 20, height: 20 },
                new go.Binding('source', 'img')
              )
            ),
            MAKE(go.Panel, 'Vertical',
              MAKE(go.TextBlock, 'Default Text', { margin: 3, stroke: 'white', font: 'bold 12px sans-serif' }, new go.Binding('text', 'name1'))
    ...
    mySelf.myDiagram.linkTemplate = MAKE(go.Link,
      ...
      MAKE(go.Shape, { strokeWidth: 2, stroke: 'yellow' }),
        ...
        new go.Binding('text', 'linktext')),
      {
        toolTip: MAKE(go.Adornment, 'Auto',
          ...
          MAKE(go.TextBlock, { margin: 2 }, new go.Binding('text', 'name1'))
        ) // end of Adornment
      }
    )// the link shape
    ...
    myModel.nodeDataArray =
        [ // note that each node data object holds whatever properties it needs;
          ...
          { key: '1', name1: '外部环境', name2: '秘书1', name3: '秘书2' },
          { key: '21', parent: '1', name1: '风况', name2: '秘书1', name3: '秘书2', linktext: '故障信息', img: require('../assets/windred.gif') },
          { key: '24', parent: '1', name1: '风况', name2: '秘书1', name3: '秘书2' },
          { key: '25', parent: '1', name1: '风况', name2: '秘书1', name3: '秘书2' },
          { key: '26', parent: '1', name1: '风况', name2: '秘书1', name3: '秘书2', linktext: '故障信息', img: require('../assets/windred.gif') },
          { key: '22', parent: '1', name1: '雷电', name2: '秘书1', name3: '秘书2' },
          { key: '23', parent: '1', name1: '海啸', name2: '秘书1', name3: '秘书2' },
          { key: '41', parent: '23', name1: '信号线缆屏蔽层未可靠接地或开路', name2: '秘书1', name3: '秘书2' },
          { key: '42', parent: '23', name1: 'AId1 EL3204模块损坏', name2: '秘书1', name3: '秘书2' },
          { key: '43', parent: '21', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2' },
          { key: '44', parent: '21', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2' },
          { key: '45', parent: '21', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2', linktext: '故障信息', img: require('../assets/windred.gif') },
          { key: '51', parent: '43', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2' },
          { key: '52', parent: '43', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2' },
          { key: '53', parent: '43', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2' },
          { key: '54', parent: '43', name1: '瞬时风速过高', name2: '秘书1', name3: '秘书2', linktext: '故障信息', img: require('../assets/windred.gif') }
          // {key:"5", parent:"42", name1: "二狗子",  name2: "秘书1", name3: "秘书2",  },
        ]
